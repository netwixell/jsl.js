...
!(function(gl, fa) {
    ...
    var ty = {
        a: function(v) {
            return v == null ? !1 : v instanceof NodeList || v instanceof HTMLCollection ? !0 : Array.isArray(v);
        },
        b: function(v) {
    ...
    return gb(Fn, 're', function(a, b) {
        ...
        if (ty.o(a)) {
            if (ty.o(a.a) && ty.s(a.selector) && ty.n(a.length)) {
                ...
                if (ty.a(va))
                    return this.selector = va[1].toLowerCase();
                if (ty.s(a.href))
                        ...
                        case 1:
                            {
                                ...
                                if (fc[0][0] >= 0 && fc[0][1] >= 0)
                                    for (var i = fc[0][0], j = 0; j < fc[0][1]; i++,
                                    j++)
                                        if (ty.o(va[i]))
                                            vb.push(va[i]);
                                va = vb;
        ...
        var ba = {
            ...
            animate: function(c, d, e) {
                ...
                if (ty.o(c)) {
                    var z = {
                        ...
                        scrollElem: function(f) {
                            var vb, vc, i = 0, vd = new Fn.re(a,b).getCoordinates(), fa = function() {
                                setTimeout(function() {
                                    if (i < f[1]) {
                                        if (f[0] === 0 || f[0] === 1)
                                            vc = vc - 1;
                ...
                if (ty.s(c)) {
                    if (c === 'scrollTop' && ty.u(d) && ty.u(e))
                        return this.a === ww || a === 'body' ? ww.pageYOffset ? ww.pageYOffset : ww.do.documentElement.scrollTop ? ww.do.documentElement.scrollTop : ww.do.body.scrollTop : this.a.scrollTop;
                    if (c === 'scrollLeft' && ty.u(d) && ty.u(e))
                        return this.a === ww || a === 'body' ? ww.pageXOffset ? ww.pageXOffset : ww.do.documentElement.scrollLeft ? ww.do.documentElement.scrollLeft : ww.do.body.scrollLeft : this.a.scrollLeft;
                    if (c === 'scrollTop' && ty.n(d) && ty.u(e))
                        ww.scrollTo(va.animate('scrollLeft'), d);
                    if (c === 'scrollLeft' && ty.n(d) && ty.u(e))
                        ww.scrollTo(d, va.animate('scrollTop'));
                    if (c === 'scrollTo' && ty.n(d) && ty.n(e))
                        ww.scrollTo(d, e);
                }
                return this;
            },
            ...
            css: function(c, d) {
                ...
                if ((ty.s(c) || ty.o(c)) && (ty.s(d) || ty.u(d))) {
                    ...
                    if (ty.s(c) && ty.u(d)) {
                        ...
                        if (fa(this.a) != !1) {
                            if (vb === 1)
                                return fa(this.a) + va[0] + va[2];
                            if (vb === 2)
                                return fa(this.a) + va[1] + va[3];
                            return fa(this.a);
                        }
                        try {
            ...
            getFocused: function(c) {
                if (this.a != ww)
                    return;
                var fa = function() {
                    if ((ww.do.visibilityState || ww.do.webkitVisibilityState) === 'hidden')
                        return !1;
                    if ((ww.do.visibilityState || ww.do.webkitVisibilityState) === 'visible')
                        return !0;
                };
                if (ty.f(c)) {
                    if (!fa())
            ...
            on: function(c, d, e) {
                ...
                if (ty.f(this.a) || this.a == null)
                    return this;
                var va = /\[object [a-zA-Z]+\]/.test(String(a)), vb = [ty.s(c) && ty.f(d) && ty.u(e), ty.s(c) && ty.s(d) && ty.f(e), ty.s(c) && ty.s(d) && e == null, ty.s(c) && d == null], vc, vd, ve = {
                    a: this.a,
                    length: this.length,
                    ...
                    var fa = function(aa) {
                        for (var i = 0; i < aa.length; i++) {
                            var fb = function(ab, ac) {
                              ...
                              , fc = function() {
                                aa[i].focus();
                                gc(aa[i]).css('background', 'rgb(255,200,200)').animate({
    ...
    (Object.setPrototypeOf || function(a, b) {
                ...
                if ((ty.f(a_2) || ty.f(a_3) || ty.f(a_4)))
                    va.onreadystatechange = function(data) {
                        if (va.readyState === 2 && a_2)
                            a_2(va);
                        if (va.readyState === 3 && a_3)
                            a_3(va);
                        if (va.readyState === 4 && a_4)
                            a_4(va);
                    }
                    ;
        ...
        hotkey: function(c, d, e) {
            ...
            if (c === 'keydown')
                new Fn.re(ww).on('keyup', function(ev) {
                    gl = [];
                });
            if (c === 'keyup')
                new Fn.re(ww).on('keypress', function(ev) {
        ...
        parserUrl: function(c) {
            ...
            if (ty.e(va.directory[0]) || ty.u(va.directory[0]))
                va.directory = '';
