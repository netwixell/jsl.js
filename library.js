...
(function(gl,fa){
    ...
    var ty={a:function(v){if(v!=null)if(typeof v==='object'&&v.length>0)return true;return Array.isArray(v);},b:function(v){return typeof v==='boolean';},e:function(v){return v==='';},
            f:function(v){return typeof v==='function';},n:function(v){return typeof v==='number';},o:function(v){return !Array.isArray(v)?typeof v==='object':false;},
            s:function(v){return typeof v==='string';},u:function(v){return typeof v==='undefined';},N:function(v){return isNaN(v);}},
    ...
    gb(fn,'re',function(a,b){
        ...
        if(ty.o(a)){
            ...
            if(ty.a(a)/*&&a.length>0*/){this.selector=a;for(var i=0;i<a.length;i++)if(ty.o(a[i]))return;}
    ...
    gb(fn.re,'dom',function(a,b){
        ...
        bc=function(g){return function(c,d,e,f){bb(g,a,c,d,e,f);}},
        bd=['addClass','html','prop','removeClass','submit','val','attr','css','on'];
        fn.re.prototype=ty.f(ww.Proxy)?new Proxy(ba,{
            get:function(t,k){
                var va=new fn.re(a,b).a;
                if(ty.f(va)&&bd.indexOf(k)==-1)return null;
                if(ty.f(va)&&bd.indexOf(k)!=-1)return function tg(c,d,e,f){bc(k)(c,d,e,f);return this};
