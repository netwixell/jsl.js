...
(function(gl,fa){
                    ...
                    var fc=function(av){
                        ...
                        for(var i=0;i<va.length;i++){
                            ...
                            if(ty.a(vb)){
                                ...
                                return[[[vb[2],vb[3]],0,sr=vb[1]],[[vb[2],vb[3]],1,sr=vb[1]],[[vb[2],vb[3]],2,sr=vb[1]],[vb[2],4,sr=vb[1]],[vb[2],3,sr=vb[1]],[vb[2],4,sr=vb[1]]][i];
                            }
                        }
                        return false;
                    }(sr),va=ww.do.querySelectorAll(sr);
                    if(ty.a(fc))
                        switch(fc[1]){
    ...
    gb(fn.re,'dom',function(a,b){
        ...
        bb=function(c,d,e,f,g,h){if(ty.u(gg[d]))gg[d]={};if(ty.u(gg[d][c]))gg[d][c]=[];if(ty.a(gg[d][c]))gg[d][c].push([e,f,g,h]);},
        ...
        for(var i in ge)if(ty.u(ba[i]))fn.re.prototype[i]=function(c,d,e,f,g){
            ...
            vc.prototype={ty:ty,gb:gb,gd:gd,gf:gf,gh:gh,gj:gj,ga:ga,gc:gc,ge:ge,gg:gg,gi:gi,gk:gk};
            fa.prototype=ba;
            new vc().fn();
            return new fa();
        };
