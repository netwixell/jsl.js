...
(function(gl, fa) {
    ...
    gb(fn, 're', function(a, b) {
        ...
        if(ty.o(a)) {
            ...
            if(ty.a(va)) {
                this.selector = va[1].toLowerCase();
                this.length = a.length;
                return;
            }
            if(ty.a(vb)) {
                if(vb[1] === 'Object') return a;
                this.selector = vb[1].toLowerCase();
                this.length = a.length;
                return;
            }
        }
    ...
    gb(fn.re, 'dom', function(a, b) {
        var ba = {
                ...
                append: function(c, d) {
                    ...
                    if(ty.s(c) || ty.o(c)) {
                        ...
                        if(ty.n(this.a.length))
                            for(var i = 0; i < this.a.length; i++) fa(this.a[i]);
                        else fa(this.a);
                    }
                    return this;
                },
                attr: function(c, d) {
                    ...
                    if(ty.s(c) && ty.u(d)) {
                        if(ty.n(this.a.length)) {
                            var va = [];
                            for(var i = 0; i < this.a.length; i++) va[i] = this.a[i].getAttribute(c);
                            return va;
                        } else
                        if(ty.o(this.a)) return this.a.getAttribute(c);
                    }
                    return this;
                },
                blur: function() {
                ...
                children: function(c) {
                    ...
                    if(this.a.children) this.a = this.a.children;
                    return this;
                },
                ...
                html: function(c) {
                    ...
                    if(ty.o(c) || ty.s(c)) {
                        ...
                        if(ty.n(this.a.length)) this.a.forEach(function(aa) {
                            fa(aa);
                        });
                        else fa(this.a);
                    }
                ...
                on: function(c, d, e) {
                    ...
                    if(ve[0] || ve[1] || ve[2] || ve[3]) {
                        ...
                        gh[vb][c]['a'] = this.a;
                        if(ty.a(this.a))
                            for(var i = 0; i < this.a.length; i++) this.a[i]['on' + c] = fa;
                        else this.a['on' + c] = fa;
                    }
                    if(ve[0] || ve[1]) {
                        var vc;
        ...
        fn.re.prototype = ty.f(ww.Proxy) ? new Proxy(ba, {
            get: function(t, k) {
                ...
                if(ty.f(va) && ty.f(bc[k])) return function tg(c, d, e, f) {
                    bc[k](a, c, d, k);
                    return this
                };
        ...
        return ty.e(a) || a === null || ty.n(a) || ty.b(a) || ty.u(a) || String(a) === '[object Object]' ? a : new fn.re(a, b);
    });
    return(Object.setPrototypeOf || function(a, b) {
        ...
        notifi: function(c) {
            ...
            if(Notification.permission === 'granted' && !ty.u(c) && !ty.e(c)) new Notification(c);
            else
            if(Notification.permission != 'denied') Notification.requestPermission(function(permission) {});
        },
        on: function(c, d) {
