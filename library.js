...
(function(gl, fa) {
    ...
    gb(fn, 're', function(a, b) {
        ...
        if (ty.o(a)) {
            var va = String(a)
                .match(/\[object HTML([a-zA-Z]+).*/),
                vb = String(a)
                .match(/\[object ([A-Z][a-z]+).*/);
            this.a = a;
            this.length = 1;
        ...
        var ba = {
                addClass: function(c) {
                    ...
                    if (!ty.e(this.a.className))
                        for (var i = 0; i < this.a.className.split(' ')
                            .length; i++)
                    ...
                    if (ty.o(c)) {
                        var z = {
                            colorRotate: function(f) {
                                var vb = (va.a.style.backgroundColor || 'rgb(255,255,255)')
                                    .match(/[rgb|rgba]\((\d+),[ ]?(\d+),[ ]?(\d+)*/),
                            ...
                            opacity: function(f) {
                                var vb = va.a.opacity = va.a.style.opacity = new fn.re(a, b)
                                    .css('opacity') || 1,
                                    fa = function() {
                                        setTimeout(function() {
                                            vb = va.a.opacity = va.a.style.opacity = (vb > f ? Number(vb) - e : Number(vb) + e)
                                                .toFixed(2);
                                            if (vb != f) fa();
                                        }, vc);
                                    };
                ...
                getIndex: function() {
                    if (ty.f(this.a) || this.a == null) return this;
                    for (var i = 0; i < new fn.re(this.a.tagName, b)
                        .a.length; i++)
                        if (new fn.re(this.a.tagName, b)
                            .a[i] === this.a)
                            return i;
                    return this;
                },
                ...
                on: function(c, d, e) {
                    ...
                    if (ve[0] || ve[1]) {
                        ...
                        if (ty.s(c) && ty.s(d) && ty.f(e))
                            vc = [e];
                        if (ty.f(this.a['on' + c]))
                            if (String(this.a['on' + c])
                                .replace(/\s+/g, ' ') != String(fa)
                                .replace(/\s+/g, ' '))
                                vc.push(this.a['on' + c]);
                        for (var i = 0; i < gh[vb][c].length; i++)
                            for (var j = 0; j < vc.length; j++)
                                if (String(gh[vb][c][i])
                                    .replace(/\s+/g, ' ') === String(vc[j])
                                    .replace(/\s+/g, ' '))
                                    vc.splice(j, 1);
                            ...
                            for (var i = 0; i < aa.length; i++) {
                                var va = aa[i],
                                    ...
                                    fc = function() {
                                        va.focus();
                                        gc(va)
                                            .css('background', 'rgb(255,225,225)')
                                            .animate({
    ...
    return (Object.setPrototypeOf || function(a, b) {
        ...
        hotkey: function(c, d, e) {
            ...
            if (c === 'keydown') new fn.re(ww)
                .on('keyup', function(ev) {
                    gj = [];
                });
            if (c === 'keyup') new fn.re(ww)
        ...
        parserUrl: function(c) {
            ...
            va.mod = (function() {
                for (var i = va.parameter.length; i > 0; i--)
                    if (ty.f(modales[String(va.parameter.slice(i - 1, va.parameter.length))
                            .split('=')[0]]))
                        return [modales[String(va.parameter.slice(i - 1, va.parameter.length))
                                .split('=')[0]], va.parameter.slice(i - 1, i)
                            .join('&'), va.parameter[i - 1]
                        ];
            })() || '';
            return va;
        },
